# Most recent summary of 3909(tropicalis) analysis:
Blast Run1, OLL = 5
```
Summary
...
```
# Most recent summary of4168(laevis) analysis:
Blastn Run1, OLL =5
```
Summary
...
There are 15485 genes that were assembled with different Chomosomes (12.5594108391325%)
 --> 11060 of 15485 Chromosome Errors are due to assembly of L/S gene fragment to one transcripts(71.42395866968034% of Chr Error, 8.9% of all assembled transcripts)
