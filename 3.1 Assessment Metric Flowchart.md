...
- 2.1 if it X.tropicalis transcriptome:
    ...
    - case 2:  chrIDs were scaffold 1-10 and chromosome 1-10 but they had the same number (ex, scaffold 9 and chromosome 9). This transcript was flagged with "Contain scaffold".  If not (ex. scaffold 9 and chromosome 1), it would be flagged with "Chromosome error". 
    - case 3: chrIDs were scaffold >10 and same chromosome (ex.scaffold 175 and chromosome2), it would be flagged with "Contain scaffold".
    - case 4:chrIDs were scaffold >10, it would be flagged with "Contain scaffold"; if chrID
